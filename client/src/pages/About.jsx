    ...
    <div>
      ...
      <section className="mt-12 max-w-5xl mx-auto px-6">
        ...
        <div className="bg-white shadow p-6 rounded-md">
          ...
          <h4 className="mt-4 text-right font-bold text-gray-900">- John Doe</h4>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="bg-white shadow p-6 rounded-md flex-1">
            ...
            <p className="mt-4 text-gray-700 text-sm">
              Jane is the visionary behind ZuriHomes, with a decade of experience in 
          ...
          <div className="bg-white shadow p-6 rounded-md flex-1">
            ...
            <p className="mt-4 text-gray-700 text-sm">
              Mark leads our technology initiatives, ensuring the platform is fast, 
      ...
      <section className="mt-12 max-w-5xl mx-auto px-6">
        ...
        <div className="bg-white shadow p-6 rounded-md">
          <p className="text-gray-700 text-lg mb-4">
            We’d love to hear from you! Reach out to us via email or phone for any inquiries.
          </p>

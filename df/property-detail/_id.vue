                                ...
                                <div class="col-xl-8">
                                    <div id="product-carousel" class="carousel slide product-detail-carousel" data-ride="carousel">
                                        ...
                                        <ol class="carousel-indicators product-carousel-indicators mt-2">
                                            ...
                                            <li data-target="#product-carousel" :data-slide-to="index" v-for="item,index in this.propertyPhotos.slice(0,4)" :key="index" 
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mt-3">
                                            <h4>
                                                Price :
                                                <b>$ {{_app_format_float_number(propertyDetail.price)}}</b>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="media mb-2">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h5 class="mt-0">
                                                            {{propertyDetail.city_name+', '+propertyDetail.states_name+', '+ propertyDetail.country_name}}
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>

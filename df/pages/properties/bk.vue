...
export default {
 ...
 components: {
  ...
  methods: {
    ...
    this.user_login_id = this.$auth.user.user_login_id;
    ...
    async searchByPhone() {
      ...
      try {
        const { properties, currentPage, totalPages, totalRecords } = await fetchProperties(this.currentPage, this.searchQuery.trim(), this.user_login_id);
        this.properties = properties;
        this.currentPage = currentPage;
        this.totalPages = totalPages;

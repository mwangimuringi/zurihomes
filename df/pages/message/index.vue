        ...
        <div class="container">
            <div class="congratulation-wrapper">
                <div class="congratulation-contents center-text">
                    ...
                    <h4 class="congratulation-contents-title"> Thank You! </h4>
                    <p class="congratulation-contents-para"> For Submitting your Application.<br> The Landlord wil be in contact if your application has been approved. </p>
                    <div class="btn-wrapper mt-4">
                        <a href="javascript:void(0)" onclick="closeTab()" class="cmn-btn btn-bg-1"> Go to Home </a>
                    </div>
                </div>
            </div>
        </div>
